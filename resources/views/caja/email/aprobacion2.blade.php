            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>
                    ...
                    <td width="600" align="left" valign="top" style="font-family:'Segoe UI',Arial,sans-serif; font-size:13px; line-height:16px; padding:0 0 30px;">
                        ...
                        <p>
                            El usuario <b>{{$solicitud->usuario->nombres}} {{$solicitud->usuario->apellidos}}</b>

                        @if($solicitud->tipo=="VIA")
                                solicita dinero para <b>Viaticos</b>.

                            @else
                                solicita de <b>Caja chica</b>.
                     ...
                     <!-- START AMPSCRIPT
                        ...
                        <p>
                           <a href="{{route("caja.aprobacionget",$solicitud->aprobacion_code)}}/?id_e={{$solicitud->id}}&estado_e=3"title="">
                            <button type="button" class="btn btn-primary btn-lg">Denegar</button></a>

                            <a href="{{route("caja.aprobacionget",$solicitud->aprobacion_code)}}/?id_e={{$solicitud->id}}&estado_e=8" title="">
                                <button type="button"  style=" background-color: #5bb642;border-color: #5bb642;" class="btn btn-primary btn-lg">Aprobar</button></a>
                        </p>
                        <p>
                            Gracias.
                        </p>
